...
function SignalHelp({signal}:{signal:Signal}){
  ...
  return <aside aria-label="Uitleg bij dit signaal" className="space-y-3 rounded-lg border bg-zinc-50 p-4 text-sm text-zinc-700">
    ...
    <details className="space-y-3">
      ...
      <p>Het oorspronkelijke gebeurtenis-ID, bericht-ID en de inhoud zijn hier niet bewaard. Daarom kunnen we deze melding niet rechtstreeks naar één bericht linken. Herhaalde afleverpogingen van dezelfde webhook kunnen meerdere meldingen opleveren.</p>
