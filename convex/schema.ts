...
export default defineSchema({
  ...
  appRequests:defineTable({orgId:v.id('orgs'),product:v.union(v.literal('frostwork'),v.literal('cashflow')),requestedBy:v.id('users'),requestedAt:v.number()}).index('by_orgId_and_product',['orgId','product']),
