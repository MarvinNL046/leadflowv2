...
| ID | Datum | Repo/site | Pagina of bereik | Wat gedaan | Status | Controle | Commit/PR | Live sinds | Vervolg |
|---|---|---|---|---|---|---|---|---|---|
| LG-046 | 2026-09-13 | leadflowv2 | /crm/webhook-signalen; webhookSignals, webhookSignalTypes, schema en messaging.updateStatusByExternalId | Per nieuwe registratie een interne UUID en tijdstip; maximaal vijf recente registraties per kanaal/oorzaak. Bij ongekoppelde e-mailbezorgstatus uitsluitend UUID-vormig Resend-bericht-ID. Uitklapbare referenties en uitleg voor historische meldingen | Klaar voor publicatie | 480 tests/51 bestanden; Convex-TypeScript en Vite-build geslaagd; algemene TypeScript bestaande diagnostiek | Deze wijziging | Nog niet bevestigd | Afzonderlijke bedrijfsproef en echte telefoonproef |
