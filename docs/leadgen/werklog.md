...
| ID | Datum | Repo/site | Pagina of bereik | Wat gedaan | Status | Controle | Commit/PR | Live sinds | Vervolg |
|---|---|---|---|---|---|---|---|---|---|
| LG-032 | 2026-09-12 | leadflowv2 | /crm/leadgen; admin.reviewServiceType; marketplaceServiceReviews | Beheerder kan type werk expliciet vastleggen of terugzetten naar onbekend, met verplichte toelichting. Controlehistorie bewaart actor, tijd, voor/na en revisie. Dekking herberekent; laatste controle zichtbaar. Verkochte aanvragen geblokkeerd en gelijktijdige wijzigingen beschermd | Getest; publicatie volgt | 349 volledige regressietests plus 4 gerichte UI-tests na laatste wijziging (350 unieke tests); Convex-TypeScript en Vite-build; geen nieuwe fouten in gewijzigde bestanden bij algemene TypeScriptcheck | Branch codex/beheer-dienst-20260912 | — | Actuele behoefte oude aanvragen bevestigen voordat ze opnieuw worden aangeboden |
